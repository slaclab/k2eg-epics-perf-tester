    ...
    for current_client_count in range(1, number_of_client + 1):
        ...
        for client_idx in range(current_client_count):
            for pv in pv_list:
                ...
                out_file_dict[pv_idx_name] = open(f"{pv_idx_name}_k2eg.csv", "w")
        ...
        with open(f'{datetime_str}_{test_prefix}_{current_client_count}_k2eg_results.csv', 'w', newline='') as file:
            ...
            for client_idx in range(current_client_count):
                for pv in pv_list:
                        ...
                        values = read_data_from_file(f"{pv}_{client_idx}_k2eg.csv")
